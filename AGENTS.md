...
После публикации темы из Google Таблицы Юра в **выбранной строке** заполняет **URL-колонку** (`/slug/`) и колонку **«Статус»** — фразу **`Не использовано`** (`shared/google_sheets_publish_row.py`).
