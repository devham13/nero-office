...
После публикации URL страницы записывается в Google Таблицу через **Google Sheets API**: `python scripts/update-google-sheet-link.py --row {N} --url "https://..."` (см. skill **publisher-yura**).
