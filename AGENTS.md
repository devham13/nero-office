...
**Целевой сайт:** только значения из env (см. docs/SITE-TARGET.md). Эталон первого экрана — главная страница текущего домена из env.

**SSH_HOST / FTP_HOST:** используй домен сайта из env (без https://), не IP панели хостинга — у IP часто закрыты порты 21/22.
