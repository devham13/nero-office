...
`google-table-manager (reserve) → Кирилл → Коля||Артём → Женя → Артур → Алина||Борис → Наташа → Юра → google-table-manager (publish) → indexator → mobile-agent → Макс → Лёня`
...
6. Далее выполни цепочку: Коля||Артём → Женя → Артур → Алина||Борис → Наташа → Юра → google-table-manager (publish) → indexator → mobile-agent → Макс → Лёня.
...
11. Если indexator, mobile-agent, Макс или Лёня нашли проблемы, максимум 2 цикла Юра → indexator → mobile-agent → Макс → Лёня.
