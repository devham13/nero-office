...
`google-table-manager (reserve) → Кирилл → Коля||Артём → Женя → Артур → Алина||Борис → Наташа → Юра → google-table-manager (publish) → indexator → Макс → Лёня`
...
6. Далее выполни цепочку: Коля||Артём → Женя → Артур → Алина||Борис → Наташа → Юра → google-table-manager (publish) → indexator → Макс → Лёня.
