...
`google-table-manager (reserve) → Кирилл → Коля||Артём → Женя → Артур → Алина||Борис → Наташа → schema-markup → Юра → google-table-manager (publish) → indexator → Макс → Лёня`
...
6. Далее выполни цепочку: Коля||Артём → Женя → Артур → Алина||Борис → Наташа → schema-markup → Юра → google-table-manager (publish) → indexator → Макс → Лёня.
...
11. Если indexator, Макс или Лёня нашли проблемы, максимум 2 цикла Юра → indexator → Макс → Лёня.
