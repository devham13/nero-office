...
<div class="nero-ai-container nero-ai-hero-grid">
    <div class="nero-ai-hero-copy">
      ...
      <div class="nero-ai-btn-row">
        <a class="nero-ai-btn nero-ai-btn-primary" href="<?php echo esc_url($primary_cta_url); ?>"<?php echo $primary_cta_attrs; ?>>Разобрать вашу почту</a>
...
(function(){
  ...
  <div class="ym-cta-block__body">
    ...
    <a href="<?php echo esc_url($primary_cta_url); ?>" class="nero-ai-btn nero-ai-btn-primary ym-btn ym-btn--accent ym-cta-block__btn"<?php echo $primary_cta_attrs; ?>>Разобрать вашу почту</a>
  </div>
</div></div>
  </section>
  ...
  <div class="ym-cta-block__body">
    ...
    <div class="ym-cta-block__actions">
      <a href="<?php echo esc_url($primary_cta_url); ?>" class="nero-ai-btn nero-ai-btn-primary ym-btn ym-btn--accent"<?php echo $primary_cta_attrs; ?>>Разобрать вашу почту</a>
    </div>
  </div>
</div>
    </div>
  ...
  <section class="vnec-section" id="cta" style="background:linear-gradient(135deg,rgba(121,242,255,.08),rgba(139,92,246,.08));">
    <div class="vnec-cnt" style="text-align:center">
      ...
      <a href="<?php echo esc_url($primary_cta_url); ?>" class="nero-ai-btn nero-ai-btn-primary ym-btn ym-btn--accent" style="font-size:16px;padding:16px 36px"<?php echo $primary_cta_attrs; ?>>Разобрать вашу почту</a>
    </div>
  </section>
