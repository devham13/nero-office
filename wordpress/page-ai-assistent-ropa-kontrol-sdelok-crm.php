...
<section class="nero-ai-hero nero-ai-hero--light" id="aark-ropa-control-hero" aria-labelledby="aark-ropa-control-hero-title">
<style>
/* ——— Hero: AI-ассистент РОПа (самодостаточный блок) ——— */
#aark-ropa-control-hero {
  --aark-bg: #f8fafc;
  --aark-text: #0f172a;
  --aark-muted: #475569;
  --aark-soft: #334155;
  ...
  background:
    radial-gradient(circle at 6% 14%, rgba(234, 88, 12, 0.07), transparent 42%),
    radial-gradient(circle at 94% 16%, rgba(220, 38, 38, 0.05), transparent 38%),
    linear-gradient(180deg, #ffffff 0%, var(--aark-bg) 100%);
  color: var(--aark-text);
  font-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
}
#aark-ropa-control-hero::before {
  content: "";
  position: absolute;
  inset: 0;
  background-image:
...
#aark-ropa-control-hero .nero-ai-container {
  width: min(var(--aark-container), calc(100% - 40px));
  margin: 0 auto;
  position: relative;
  z-index: 1;
}
#aark-ropa-control-hero .nero-ai-hero-grid {
  display: grid;
  grid-template-columns: minmax(0, 1.05fr) minmax(340px, 0.95fr);
  gap: clamp(28px, 4vw, 52px);
  align-items: center;
}
#aark-ropa-control-hero .nero-ai-eyebrow {
  display: inline-flex;
  align-items: center;
  gap: 8px;
  margin: 0 0 16px;
  ...
  color: var(--aark-primary);
  font-size: 12px;
  font-weight: 800;
  letter-spacing: 0.1em;
  text-transform: uppercase;
}
#aark-ropa-control-hero .nero-ai-hero-copy h1 {
  margin: 0;
  max-width: 760px;
...
#aark-ropa-control-hero .nero-ai-gradient-text {
  display: block;
  background: linear-gradient(92deg, #ea580c 0%, #dc2626 48%, #9333ea 100%);
  -webkit-background-clip: text;
  background-clip: text;
  color: transparent !important;
}
#aark-ropa-control-hero .nero-ai-hero-lead {
  margin: 22px 0 0;
  max-width: 680px;
...
#aark-ropa-control-hero .nero-ai-badges {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
  margin: 24px 0 0;
...
#aark-ropa-control-hero .nero-ai-badge {
  padding: 8px 12px;
  border: 1px solid var(--aark-border);
  border-radius: 999px;
  background: #fff;
  color: var(--aark-soft);
  font-size: 13px;
...
#aark-ropa-control-hero .nero-ai-btn-row {
  display: flex;
  flex-wrap: wrap;
  gap: 12px;
  margin-top: 30px;
}
#aark-ropa-control-hero .nero-ai-btn {
  display: inline-flex;
  align-items: center;
...
#aark-ropa-control-hero .nero-ai-btn:hover { transform: translateY(-2px); }
#aark-ropa-control-hero .nero-ai-btn-primary {
  color: #fff !important;
  background: linear-gradient(135deg, #ea580c, #f97316);
  box-shadow: 0 14px 36px rgba(234, 88, 12, 0.28);
}
#aark-ropa-control-hero .nero-ai-btn-secondary {
  color: var(--aark-primary) !important;
  background: #fff;
  border: 1px solid rgba(234, 88, 12, 0.28);
}
#aark-ropa-control-hero .nero-ai-reveal {
  opacity: 0;
  transform: translateY(18px);
  transition: opacity 0.55s ease, transform 0.55s ease;
}
#aark-ropa-control-hero .nero-ai-reveal.nero-ai-active {
  opacity: 1;
  transform: none;
}
#aark-ropa-control-hero .nero-ai-delay-2 { transition-delay: 0.12s; }

#aark-ropa-control-hero .nero-ai-dashboard {
  position: relative;
  padding: 16px;
  border-radius: 28px;
...
#aark-ropa-control-hero .nero-ai-dashboard-shell {
  overflow: hidden;
...
#aark-ropa-control-hero .nero-ai-window-top {
  display: flex;
  align-items: center;
...
#aark-ropa-control-hero .nero-ai-dots { display: flex; gap: 7px; }
#aark-ropa-control-hero .nero-ai-dot {
  width: 10px;
  height: 10px;
  border-radius: 50%;
}
#aark-ropa-control-hero .nero-ai-dot:nth-child(1) { background: #fb7185; }
#aark-ropa-control-hero .nero-ai-dot:nth-child(2) { background: #fbbf24; }
#aark-ropa-control-hero .nero-ai-dot:nth-child(3) { background: #34d399; }
#aark-ropa-control-hero .nero-ai-window-title {
  color: #cfe3f9;
  font-size: 11px;
  font-weight: 750;
...
#aark-ropa-control-hero .nero-ai-window-body { padding: 16px; }
#aark-ropa-control-hero .nero-ai-dashboard-title {
  display: flex;
...
#aark-ropa-control-hero .nero-ai-dashboard-title h3 {
  margin: 0;
  font-size: 18px;
  letter-spacing: -0.03em;
  color: #fff;
}
#aark-ropa-control-hero .nero-ai-live-pill {
  display: inline-flex;
  align-items: center;
  gap: 7px;
  padding: 6px 9px;
...
#aark-ropa-control-hero .nero-ai-live-pill::before {
  content: "";
  width: 7px;
  height: 7px;
  border-radius: 50%;
  ...
  animation: aarkRopPulse 1.5s ease-in-out infinite;
}
@keyframes aarkRopPulse {
  0%, 100% { transform: scale(0.86); opacity: 0.65; }
  50% { transform: scale(1); opacity: 1; }
}
#aark-ropa-control-hero .nero-ai-metrics-grid {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 10px;
}
#aark-ropa-control-hero .nero-ai-metric {
  padding: 12px;
...
#aark-ropa-control-hero .nero-ai-metric:hover {
  transform: translateY(-2px);
  border-color: rgba(251, 146, 60, 0.35);
}
#aark-ropa-control-hero .nero-ai-metric span {
  display: block;
  color: #94a3b8;
  font-size: 11px;
  font-weight: 700;
}
#aark-ropa-control-hero .nero-ai-metric strong {
  display: block;
  margin-top: 6px;
  color: #fff;
  font-size: 22px;
...
#aark-ropa-control-hero .nero-ai-metric small {
  display: block;
  margin-top: 5px;
  color: #9fb0c9;
  font-size: 11px;
}
#aark-ropa-control-hero .aark-risk-stages {
  margin-top: 14px;
  padding: 12px;
...
#aark-ropa-control-hero .aark-risk-stages-title {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 800;
  color: #dce8f7;
}
#aark-ropa-control-hero .aark-risk-row {
  display: grid;
...
#aark-ropa-control-hero .aark-risk-row:last-child { margin-bottom: 0; }
#aark-ropa-control-hero .aark-risk-label {
  font-size: 11px;
  font-weight: 700;
  color: #cbd5e1;
}
#aark-ropa-control-hero .aark-risk-track {
  height: 8px;
  border-radius: 999px;
  background: rgba(255, 255, 255, 0.08);
  overflow: hidden;
}
#aark-ropa-control-hero .aark-risk-fill {
  display: block;
  height: 100%;
  width: 0;
...
#aark-ropa-control-hero .aark-risk-fill--low { background: linear-gradient(90deg, #22c55e, #4ade80); }
#aark-ropa-control-hero .aark-risk-fill--mid { background: linear-gradient(90deg, #f59e0b, #fbbf24); }
#aark-ropa-control-hero .aark-risk-fill--high { background: linear-gradient(90deg, #ef4444, #f87171); }
#aark-ropa-control-hero .aark-risk-fill--crit { background: linear-gradient(90deg, #dc2626, #fb7185); }
#aark-ropa-control-hero .aark-risk-val {
  font-size: 11px;
  font-weight: 800;
  color: #f8fafc;
  text-align: right;
}
#aark-ropa-control-hero .nero-ai-task-stream {
  margin-top: 12px;
  display: grid;
  gap: 8px;
}
#aark-ropa-control-hero .nero-ai-task {
  display: grid;
...
#aark-ropa-control-hero .nero-ai-task.is-highlight {
  border-color: rgba(251, 146, 60, 0.45);
  background: rgba(234, 88, 12, 0.12);
  animation: aarkBriefGlow 2.4s ease-in-out infinite;
}
@keyframes aarkBriefGlow {
  0%, 100% { box-shadow: 0 0 0 rgba(234, 88, 12, 0); }
  50% { box-shadow: 0 0 22px rgba(234, 88, 12, 0.22); }
}
#aark-ropa-control-hero .nero-ai-task-icon {
  display: grid;
  place-items: center;
  width: 28px;
  height: 28px;
...
#aark-ropa-control-hero .nero-ai-task strong {
  display: block;
  color: #f8fafc;
  font-size: 12px;
}
#aark-ropa-control-hero .nero-ai-task span {
  color: #94a3b8;
  font-size: 11px;
}
#aark-ropa-control-hero .nero-ai-status {
  padding: 4px 8px;
  border-radius: 999px;
  font-size: 10px;
  font-weight: 800;
...
#aark-ropa-control-hero .nero-ai-status--crit {
  background: rgba(239, 68, 68, 0.18);
  color: #fecaca;
}
#aark-ropa-control-hero .nero-ai-status--warn {
  background: rgba(245, 158, 11, 0.14);
  color: #fde68a;
}
#aark-ropa-control-hero .nero-ai-status--done {
  background: rgba(34, 197, 94, 0.14);
  color: #bbf7d0;
}
#aark-ropa-control-hero .nero-ai-status--live {
  background: rgba(251, 146, 60, 0.18);
  color: #fed7aa;
}
#aark-ropa-control-hero .aark-control-cycle {
  margin-top: 12px;
  display: grid;
  grid-template-columns: repeat(4, 1fr);
  gap: 6px;
}
#aark-ropa-control-hero .aark-cycle-step {
  padding: 8px 6px;
  border-radius: 12px;
...
#aark-ropa-control-hero .aark-cycle-step.is-active {
  border-style: solid;
  border-color: rgba(251, 146, 60, 0.45);
  color: #fed7aa;
  background: rgba(234, 88, 12, 0.1);
}
#aark-ropa-control-hero [data-nero-tooltip] { position: relative; cursor: help; }
#aark-ropa-control-hero [data-nero-tooltip]::after {
...
#aark-ropa-control-hero [data-nero-tooltip]:hover::after,
#aark-ropa-control-hero [data-nero-tooltip].nero-ai-tooltip-active::after {
  opacity: 1;
  transform: translate(-50%, 0);
}
@media (max-width: 1024px) {
  #aark-ropa-control-hero .nero-ai-hero-grid { grid-template-columns: 1fr; }
  #aark-ropa-control-hero .nero-ai-dashboard { transform: none; }
  #aark-ropa-control-hero { min-height: auto; padding-top: 72px; }
}
@media (max-width: 520px) {
  #aark-ropa-control-hero .nero-ai-metrics-grid { grid-template-columns: 1fr; }
  #aark-ropa-control-hero .aark-control-cycle { grid-template-columns: repeat(2, 1fr); }
  #aark-ropa-control-hero .nero-ai-task { grid-template-columns: 28px 1fr; }
  #aark-ropa-control-hero .nero-ai-status { grid-column: 2; width: fit-content; }
}
@media (prefers-reduced-motion: reduce) {
  #aark-ropa-control-hero *,
  #aark-ropa-control-hero *::before,
  #aark-ropa-control-hero *::after {
    animation: none !important;
    transition: none !important;
  }
  #aark-ropa-control-hero .nero-ai-reveal { opacity: 1; transform: none; }
  #aark-ropa-control-hero .aark-risk-fill { width: var(--aark-risk-w, 0%) !important; }
}
</style>
