...
<section class="nero-ai-hero nero-ai-hero--light" id="crm-reactivation-hero" aria-labelledby="crm-reactivation-hero-title">
<style>
/* ——— Hero: реактивация CRM (самодостаточный блок) ——— */
#crm-reactivation-hero {
  --crm-hero-bg: #f8fafc;
  --crm-hero-text: #0f172a;
  --crm-hero-muted: #475569;
  --crm-hero-soft: #334155;
  --crm-hero-border: #e2e8f0;
  --crm-hero-primary: #2563eb;
  --crm-hero-accent: #7c3aed;
  --crm-hero-success: #16a34a;
  --crm-hero-warn: #d97706;
  --crm-hero-container: 1220px;
  position: relative;
  isolation: isolate;
  min-height: min(920px, calc(100dvh - 1px));
  display: grid;
  align-items: center;
  padding: clamp(96px, 12vh, 140px) 0 clamp(48px, 7vw, 80px);
  background:
    radial-gradient(circle at 8% 12%, rgba(37, 99, 235, 0.08), transparent 42%),
    radial-gradient(circle at 92% 18%, rgba(124, 58, 237, 0.06), transparent 38%),
    linear-gradient(180deg, #ffffff 0%, var(--crm-hero-bg) 100%);
  color: var(--crm-hero-text);
  font-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
}
#crm-reactivation-hero::before {
  content: "";
  position: absolute;
  inset: 0;
  background-image:
...
#crm-reactivation-hero .nero-ai-container {
  width: min(var(--crm-hero-container), calc(100% - 40px));
  margin: 0 auto;
  position: relative;
  z-index: 1;
}
#crm-reactivation-hero .nero-ai-hero-grid {
  display: grid;
  grid-template-columns: minmax(0, 1.05fr) minmax(340px, 0.95fr);
  gap: clamp(28px, 4vw, 52px);
  align-items: center;
}
#crm-reactivation-hero .nero-ai-eyebrow {
  display: inline-flex;
  align-items: center;
  gap: 8px;
  margin: 0 0 16px;
  ...
  color: var(--crm-hero-primary);
  font-size: 12px;
  font-weight: 800;
  letter-spacing: 0.1em;
  text-transform: uppercase;
}
#crm-reactivation-hero .nero-ai-hero-copy h1 {
  margin: 0;
  max-width: 760px;
...
#crm-reactivation-hero .nero-ai-gradient-text {
  display: block;
  background: linear-gradient(92deg, #2563eb 0%, #7c3aed 52%, #db2777 100%);
  -webkit-background-clip: text;
  background-clip: text;
  color: transparent !important;
}
#crm-reactivation-hero .nero-ai-hero-lead {
  margin: 22px 0 0;
  max-width: 680px;
...
#crm-reactivation-hero .nero-ai-badges {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
  margin: 24px 0 0;
...
#crm-reactivation-hero .nero-ai-badge {
  padding: 8px 12px;
  border: 1px solid var(--crm-hero-border);
  border-radius: 999px;
  background: #fff;
  color: var(--crm-hero-soft);
  font-size: 13px;
  font-weight: 700;
  box-shadow: 0 2px 8px rgba(15, 23, 42, 0.04);
}
#crm-reactivation-hero .nero-ai-btn-row {
  display: flex;
  flex-wrap: wrap;
  gap: 12px;
  margin-top: 30px;
}
#crm-reactivation-hero .nero-ai-btn {
  display: inline-flex;
  align-items: center;
...
#crm-reactivation-hero .nero-ai-btn:hover { transform: translateY(-2px); }
#crm-reactivation-hero .nero-ai-btn-primary {
  color: #fff !important;
  background: linear-gradient(135deg, #2563eb, #3b82f6);
  box-shadow: 0 14px 36px rgba(37, 99, 235, 0.28);
}
#crm-reactivation-hero .nero-ai-btn-secondary {
  color: var(--crm-hero-primary) !important;
  background: #fff;
  border: 1px solid rgba(37, 99, 235, 0.28);
}
#crm-reactivation-hero .nero-ai-reveal {
  opacity: 0;
  transform: translateY(18px);
  transition: opacity 0.55s ease, transform 0.55s ease;
}
#crm-reactivation-hero .nero-ai-reveal.nero-ai-active {
  opacity: 1;
  transform: none;
}
#crm-reactivation-hero .nero-ai-delay-2 { transition-delay: 0.12s; }

/* Dashboard (тёмная карточка на светлом hero) */
#crm-reactivation-hero .nero-ai-dashboard {
  position: relative;
  padding: 16px;
  border-radius: 28px;
...
#crm-reactivation-hero .nero-ai-dashboard-shell {
  overflow: hidden;
  border: 1px solid rgba(255, 255, 255, 0.12);
  border-radius: 22px;
  background: linear-gradient(180deg, rgba(15, 23, 42, 0.97), rgba(6, 10, 24, 0.98));
  color: #e6edf7;
}
#crm-reactivation-hero .nero-ai-window-top {
  display: flex;
  align-items: center;
...
#crm-reactivation-hero .nero-ai-dots { display: flex; gap: 7px; }
#crm-reactivation-hero .nero-ai-dot {
  width: 10px;
  height: 10px;
  border-radius: 50%;
}
#crm-reactivation-hero .nero-ai-dot:nth-child(1) { background: #fb7185; }
#crm-reactivation-hero .nero-ai-dot:nth-child(2) { background: #fbbf24; }
#crm-reactivation-hero .nero-ai-dot:nth-child(3) { background: #34d399; }
#crm-reactivation-hero .nero-ai-window-title {
  color: #cfe3f9;
  font-size: 11px;
  font-weight: 750;
...
#crm-reactivation-hero .nero-ai-window-body { padding: 16px; }
#crm-reactivation-hero .nero-ai-dashboard-title {
  display: flex;
...
#crm-reactivation-hero .nero-ai-dashboard-title h3 {
  margin: 0;
  font-size: 18px;
  letter-spacing: -0.03em;
  color: #fff;
}
#crm-reactivation-hero .nero-ai-live-pill {
  display: inline-flex;
  align-items: center;
  gap: 7px;
  padding: 6px 9px;
...
#crm-reactivation-hero .nero-ai-live-pill::before {
  content: "";
  width: 7px;
  height: 7px;
  border-radius: 50%;
  ...
  animation: crmReactivPulse 1.5s ease-in-out infinite;
}
@keyframes crmReactivPulse {
  0%, 100% { transform: scale(0.86); opacity: 0.65; }
  50% { transform: scale(1); opacity: 1; }
}
#crm-reactivation-hero .nero-ai-metrics-grid {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 10px;
}
#crm-reactivation-hero .nero-ai-metric {
  padding: 12px;
...
#crm-reactivation-hero .nero-ai-metric:hover {
  transform: translateY(-2px);
  border-color: rgba(167, 139, 250, 0.35);
}
#crm-reactivation-hero .nero-ai-metric span {
  display: block;
  color: #94a3b8;
  font-size: 11px;
  font-weight: 700;
}
#crm-reactivation-hero .nero-ai-metric strong {
  display: block;
  margin-top: 6px;
  color: #fff;
  font-size: 22px;
...
#crm-reactivation-hero .nero-ai-metric small {
  display: block;
  margin-top: 5px;
  color: #9fb0c9;
  font-size: 11px;
}
#crm-reactivation-hero .crm-segments {
  margin-top: 14px;
  padding: 12px;
...
#crm-reactivation-hero .crm-segments-title {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 800;
  color: #dce8f7;
}
#crm-reactivation-hero .crm-segment-row {
  display: grid;
...
#crm-reactivation-hero .crm-segment-row:last-child { margin-bottom: 0; }
#crm-reactivation-hero .crm-segment-label {
  font-size: 11px;
  font-weight: 700;
  color: #cbd5e1;
}
#crm-reactivation-hero .crm-segment-track {
  height: 8px;
  border-radius: 999px;
  background: rgba(255, 255, 255, 0.08);
  overflow: hidden;
}
#crm-reactivation-hero .crm-segment-fill {
  display: block;
  height: 100%;
  width: 0;
...
#crm-reactivation-hero .crm-segment-fill.is-ready { width: var(--crm-seg-w, 0%); }
#crm-reactivation-hero .crm-segment-fill--cold { background: linear-gradient(90deg, #64748b, #94a3b8); }
#crm-reactivation-hero .crm-segment-fill--sleep { background: linear-gradient(90deg, #6366f1, #818cf8); }
#crm-reactivation-hero .crm-segment-fill--warm { background: linear-gradient(90deg, #f59e0b, #fbbf24); }
#crm-reactivation-hero .crm-segment-fill--hot { background: linear-gradient(90deg, #22c55e, #4ade80); }
#crm-reactivation-hero .crm-segment-val {
  font-size: 11px;
  font-weight: 800;
  color: #f8fafc;
  text-align: right;
}
#crm-reactivation-hero .nero-ai-task-stream {
  margin-top: 12px;
  display: grid;
  gap: 8px;
}
#crm-reactivation-hero .nero-ai-task {
  display: grid;
...
#crm-reactivation-hero .nero-ai-task.is-highlight {
  border-color: rgba(167, 139, 250, 0.45);
  background: rgba(124, 58, 237, 0.12);
  animation: crmReactivTaskGlow 2.4s ease-in-out infinite;
}
@keyframes crmReactivTaskGlow {
  0%, 100% { box-shadow: 0 0 0 rgba(124, 58, 237, 0); }
  50% { box-shadow: 0 0 22px rgba(124, 58, 237, 0.22); }
}
#crm-reactivation-hero .nero-ai-task-icon {
  display: grid;
  place-items: center;
  width: 28px;
  height: 28px;
...
#crm-reactivation-hero .nero-ai-task strong {
  display: block;
  color: #f8fafc;
  font-size: 12px;
}
#crm-reactivation-hero .nero-ai-task span {
  color: #94a3b8;
  font-size: 11px;
}
#crm-reactivation-hero .nero-ai-status {
  padding: 4px 8px;
  border-radius: 999px;
  font-size: 10px;
  font-weight: 800;
...
#crm-reactivation-hero .nero-ai-status--queue {
  background: rgba(245, 158, 11, 0.14);
  color: #fde68a;
}
#crm-reactivation-hero .nero-ai-status--done {
  background: rgba(34, 197, 94, 0.14);
  color: #bbf7d0;
}
#crm-reactivation-hero .nero-ai-status--live {
  background: rgba(167, 139, 250, 0.18);
  color: #e9d5ff;
}
#crm-reactivation-hero .crm-mini-funnel {
  margin-top: 12px;
  display: grid;
  grid-template-columns: repeat(4, 1fr);
  gap: 6px;
}
#crm-reactivation-hero .crm-funnel-step {
  padding: 8px 6px;
  border-radius: 12px;
...
#crm-reactivation-hero .crm-funnel-step.is-active {
  border-style: solid;
  border-color: rgba(34, 197, 94, 0.45);
  color: #bbf7d0;
  background: rgba(34, 197, 94, 0.1);
}
#crm-reactivation-hero [data-nero-tooltip] { position: relative; cursor: help; }
#crm-reactivation-hero [data-nero-tooltip]::after {
...
#crm-reactivation-hero [data-nero-tooltip]:hover::after,
#crm-reactivation-hero [data-nero-tooltip].nero-ai-tooltip-active::after {
  opacity: 1;
  transform: translate(-50%, 0);
}
@media (max-width: 1024px) {
  #crm-reactivation-hero .nero-ai-hero-grid { grid-template-columns: 1fr; }
  #crm-reactivation-hero .nero-ai-dashboard { transform: none; }
  #crm-reactivation-hero { min-height: auto; padding-top: 72px; }
}
@media (max-width: 520px) {
  #crm-reactivation-hero .nero-ai-metrics-grid { grid-template-columns: 1fr; }
  #crm-reactivation-hero .crm-mini-funnel { grid-template-columns: repeat(2, 1fr); }
  #crm-reactivation-hero .nero-ai-task { grid-template-columns: 28px 1fr; }
  #crm-reactivation-hero .nero-ai-status { grid-column: 2; width: fit-content; }
}
@media (prefers-reduced-motion: reduce) {
  #crm-reactivation-hero *,
  #crm-reactivation-hero *::before,
  #crm-reactivation-hero *::after {
    animation: none !important;
    transition: none !important;
  }
  #crm-reactivation-hero .nero-ai-reveal { opacity: 1; transform: none; }
  #crm-reactivation-hero .crm-segment-fill { width: var(--crm-seg-w, 0%) !important; }
}
</style>
