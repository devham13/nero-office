/**
 * Плавающая pill-шапка: мобильное меню, smooth scroll по якорям.
 */
(function () {
  "use strict";

  function initNeroAiFloatingHeader() {
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initNeroAiFloatingHeader);
  } else {
    initNeroAiFloatingHeader();
  }
})();
