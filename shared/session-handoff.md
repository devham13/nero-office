...
## 2026-06-13 — vnedrenie-ai-zayavki-vk-telegram

- Юра: опубликовано `[REDACTED]vnedrenie-ai-zayavki-vk-telegram/` (HTTP 200, custom template page-vnedrenie-ai-zayavki-vk-telegram.php, WP post ID 158).
- Google Таблица: строка 105 — URL записан (service_account).
