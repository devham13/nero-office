...
$secondary_cta_attrs = (!empty($secondary_cta_url) && function_exists('nero_ai_primary_cta_link_attrs')) ? nero_ai_primary_cta_link_attrs($secondary_cta_url) : '';
$logo_src = '';
    ...
    <div class="nero-ai-header-bar">
      ...
      <div class="nero-ai-header-actions">
        <?php if (!empty($secondary_cta_label) && !empty($secondary_cta_url)) : ?>
          <a class="nero-ai-header-cta nero-ai-header-cta--ghost" href="<?php echo esc_url($secondary_cta_url); ?>"<?php echo $secondary_cta_attrs; ?>><?php echo esc_html($secondary_cta_label); ?></a>
        <?php endif; ?>
