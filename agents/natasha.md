...
1. **Прочитай** файл обмена — блок `=== CONTENT-REWRITER-HUMANIZER ===` (humanized-текст), hero Алины, блок Бориса. **Не** откатывай текст к сухому шаблону Жени/Артура; верстай humanized-копирайт.
...
- Источник текста секций — `=== CONTENT-REWRITER-HUMANIZER ===`.
- Hero: HTML/Canvas Алины не трогать; текстовые узлы — по humanized блоку Hero.
- См. `shared/humanizer_rules.md`.

## Запреты

- **Не** «сушить» или канцеляризовать текст после humanizer.
