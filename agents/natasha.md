...
- **Не добавлять `nero-ai-hero--light`**
- Не терять рекламные блоки Артура: главный CTA из env, уместное упоминание `SECONDARY_CTA_URL`, нижний баннер из AD_BANNER_*. и белый inline CSS на hero — тёмная гамма ${SITE_BRAND} как у всей страницы.
